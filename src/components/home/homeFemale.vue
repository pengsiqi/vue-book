<template>
    <div id="homeMale">
        ...
        <imgBook :bookData='femaleBookInfo.books' v-if="femaleBookInfo!==''"></imgBook>
        <div class="more" v-if="femaleBookInfo!==''">
            <div>
        ...
        <div class="loading" v-show="femaleBookInfo===''"></div>
    </div>
</template>
